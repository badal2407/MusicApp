...
/*class PlayerActivity : AppCompatActivity(), ServiceConnection  , MediaPlayer.OnCompletionListener {
           ...
           if(!timer) showBottomSheetDialog()
               ...
               builder.setTitle("Stop Timer")
                   ...
                   .setPositiveButton("Yes"){_, _ ->
                       ...
                       min30 = false
                       min60 = false
                       binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this,R.color.icon_color))
                   }
    ...
    private fun setLayout() {
        ...
        if(min15 || min30 || min60)  binding.timerBtnPA.setColorFilter(ContextCompat.getColor(applicationContext,R.color.red))
    ...
    private fun showBottomSheetDialog(){
        ...
        dialog.findViewById<LinearLayout>(R.id.min_15)?.setOnClickListener {
            Toast.makeText(baseContext,"After 15 minutes music will stop",Toast.LENGTH_SHORT).show()
        ...
        dialog.findViewById<LinearLayout>(R.id.min_30)?.setOnClickListener {
            Toast.makeText(baseContext,"After 30 minutes music will stop",Toast.LENGTH_SHORT).show()
            binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this,R.color.red))
            min15 = true
        ...
        dialog.findViewById<LinearLayout>(R.id.min_60)?.setOnClickListener {
            Toast.makeText(baseContext,"After 60 minutes music will stop",Toast.LENGTH_SHORT).show()
            binding.timerBtnPA.setColorFilter(ContextCompat.getColor(this,R.color.red))
            min15 = true
...
import com.das_develop.cloudpod.databinding.ActivityPlayerBinding
    ...
    private fun setLayout(){
        ...
        val image = if (img != null) {
            ...
            BitmapFactory.decodeResource(
                resources,
                R.drawable.logo_icon_slash_screen
            )
        }
