...
/*class MainActivity : AppCompatActivity() {
    ...
    companion object{
      ...
      var search:Boolean =false
        ...
        val currentTheme = arrayOf(R.style.coolRed,R.style.cloudBlue,R.style.coolTeal,R.style.coolGreen,R.style.coolBlack)
        val currentThemeNav = arrayOf(R.style.coolRedNav,R.style.cloudBlueNav,R.style.coolTealNav,R.style.coolGreenNav,R.style.coolBlackNav)
        val currentGradient = arrayOf(R.drawable.gradient_red,R.drawable.gradient_blue,
            R.drawable.gradient_teal,R.drawable.gradient_green,R.drawable.gradient_black)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.navView.setNavigationItemSelectedListener{
            ...
            when(it.itemId)
            {
                ...
                R.id.navSetting -> startActivity(Intent(this,SettingActivity::class.java))
    ...
    override fun onResume() {
        super.onResume()
        //for storing data using shared preference
...
import com.das_develop.cloudpod.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    companion object{
        ...
        var themeIndex: Int = 0
        val currentTheme = arrayOf(R.style.coolRed, R.style.cloudBlue, R.style.coolTeal, R.style.coolGreen, R.style.coolBlack)
        val currentThemeNav = arrayOf(R.style.coolRedNav, R.style.cloudBlueNav, R.style.coolTealNav, R.style.coolGreenNav,
            R.style.coolBlackNav)
        val currentGradient = arrayOf(R.drawable.gradient_red, R.drawable.gradient_blue, R.drawable.gradient_teal, R.drawable.gradient_green,
...
//                R.id.navFeedback -> startActivity(Intent(this@MainActivity, FeedbackActivity::class.java))
                R.id.navSetting -> startActivity(Intent(this@MainActivity, SettingActivity::class.java))
